...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/sumire-1.avif",
			"assets/images/DesktopWallpaper/sumire-2.avif",
			"assets/images/DesktopWallpaper/sumire-3.avif",
			"assets/images/DesktopWallpaper/sumire-4.avif",
			"assets/images/DesktopWallpaper/sumire-5.avif",
			"assets/images/DesktopWallpaper/sumire-6.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/sumire-m1.avif",
			"assets/images/MobileWallpaper/sumire-m2.avif",
			"assets/images/MobileWallpaper/sumire-m3.avif",
			"assets/images/MobileWallpaper/sumire-m4.avif",
			"assets/images/MobileWallpaper/sumire-m5.avif",
			"assets/images/MobileWallpaper/sumire-m6.avif",
		],
		// 背景视频播放地址
